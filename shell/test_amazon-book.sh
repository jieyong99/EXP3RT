...
# echo "dataset: $dataset, seed: $seed, lora_r: $lora_r, lora_alpha: $lora_alpha, TEST WITH VLLM!!"
# CUDA_VISIBLE_DEVICES=0 python -u test.py \
#     --base_model $base_model \
#     --dataset $dataset \
#     --test_data_path "data/${dataset}/rating_bias/${data_type}.json" \
#     --output_dir "amazon-book_r128_alpha32_seed42_lr4e-4_result.json" \
#     --seed $seed \
#     --saved_path "amazon-book_r128_alpha32_seed42_lr4e-4/merged"

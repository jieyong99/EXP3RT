...
callback = SaveBestModelCallback(save_dir=save_dir, output_dir=output_dir, model=model, tokenizer=tokenizer, rmse_patience=rmse_patience, valid_ratio_patience=5)
